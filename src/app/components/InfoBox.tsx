    ...
    return(
        <div>
            <div className="infobox box-content h-48 w-64 p-4 border-2 bg-gray-500 rounded-md">           
                ...
                <h5 className="italic text-1xl text-slate-300">{props.description}</h5>
                <br/>
                <div className="grid grid-cols-2 gap-4 place-content-between h-48 ...">
                    <button className="info_button bg-blue-500 hover:bg-blue-700 text-white font-bold px-3 rounded-lg" onClick={() => handleClick(props.repositoryURL)}>
                        View Project
                    </button>
                </div>
