...
// TODO: Rewrite this page to be dynamic!
...
function Cyst() {
  ...
  <div className="py-5">
    ...
    <p className="text-slate-500 py-5 px-2 mr-10 ml-10">Cyst is a project that is developed with GDScript in the Godot Engine.
     This project was created for the New Year New Skills Game Jam on Itch.io, the theme for the jam was building connections.
